...
use Src\Administrator\Plan\Application\Get\GetPlanByCode;
...
use Src\Administrator\Plandbf\Application\Create\PlandbfCreator;
use Src\Administrator\Plandbf\Application\Get\GetPlandbfByidEquivSis;
use Src\Administrator\Plandbf\Application\Update\PlandbfUpdater;
use Src\Administrator\Plandbf\Infrastructure\Persistence\Eloquent\EloquentPlandbfRepository;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\DB;

final class UpdatePlandbfController
{
    private $repository;
    ...
    public function __invoke(int $idEquivSis, Request $request)
    {
        ...
        Log::info('data_request_update', [
            'data_request_plan_dbf_update' => $request->all()
        ]);
